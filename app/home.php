	...
	<body>
		<?php
			...
			<table>
				<tr>
					<td><h2>User ID : </h2></td>
					<td><h1 style="color:green;">'.$_SESSION['uid'].'</h1></td>
				</tr>
				<tr>
					<td><h2>Name : </h2></td>
					<td><h1 style="color:green;">'.$_SESSION['first_name'].' '.$_SESSION['last_name'].'</h1></td>
				</tr>
				<tr>
					<td><h2>Email : </h2></td>
				...
				<tr>
					<td><h2>Date : </h2></td>
					<td><h1 style="color:green;">'.date("Y-m-d h:i:sa").'</h1></td>
				</tr>
			</table>';
		?>
